...
public class Averia {
	...
	public void desassign() {
		// Solo se puede desasignar una averia que está ASIGNADA
		if (this.status.equals(AveriaStatus.ASIGNADA)) {
			// unlink de averia y mecanico
