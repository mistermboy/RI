...
public class LiquidarFacturaTests {
	...
	public void testImporteCero() throws BusinessException {
		Averia a = crearAveriaTerminada(m, v, 0);
	...
	/**
	 * No se puede marcar como liquidada una factura que no esté totalmente pagada
	 * con margen de +-0,01 €
	 */
	@Test(expected = BusinessException.class)
	...
	/**
	 * Se puede marcar como liquidada una factura completamente pagada dentro del
	 * margen +-0,01 €
	 */
	@Test
	...
	/**
	 * Se puede marcar como liquidada una factura completamente pagada con margen de
	 * +-0,01 €
	 */
	@Test
