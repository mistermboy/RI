...
public class BonoPor3AveriasTests {
	...
	public void setUp() throws Exception {
		...
		TipoVehiculo tv = new TipoVehiculo("tv", 30);
	...
	/**
	 * Un cliente con tres averias pagadas y no usuadas para bono devuelve esas tres
	 * averias como elegibles para bono por 3 averías (bono3)
	 * 
	 * @throws BusinessException
	 */
	@Test
	public void test3AveriasGeneranBono() throws BusinessException {
		Factura f = new Factura(123L, as);
	...
	/**
	 * Un cliente con tres averias facturadas y no pagadas no devuelve averías como
	 * elegibles para bono por 3 averías
	 * 
	 * @throws BusinessException
	 */
	@Test
	...
	/**
	 * Un cliente con dos averias pagadas y no usuadas para bono devuelve solo dos
	 * averias como elegibles para bono por 3 averías
	 * 
	 * @throws BusinessException
	 */
	@Test
	...
	public void test2AveriasPagadas1NoPagada() throws BusinessException {
		...
		new Cargo(f, cash, f.getImporte());
		f.settle();
		new Factura(234L, Arrays.asList(a));
	...
	/**
	 * Un cliente con tres averias pagadas y una ya usuada para bono devuelve dos
	 * averias como elegibles para bono por 3 averías
	 * 
	 * @throws BusinessException
	 */
	...
	public void test3AveriasPagadas1Usada() throws BusinessException {
		Averia a = as.get(0);
		as.remove(0);
		Factura f1 = new Factura(123L, as);
		new Cargo(f1, cash, f1.getImporte());
		f1.settle();

		Factura f2 = new Factura(234L, Arrays.asList(a));
	...
	/**
	 * Un cliente con 5 averias pagadas y no usuadas para bono devuelve las 5 como
	 * elegibles para bono por 3 averías
	 * 
	 * @throws BusinessException
	 */
