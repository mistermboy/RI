...
public class GenerateVouchersByNumberOfBreakdowns extends BaseServiceTests {
	...
	/**
	 * Se genera un bono por tres averias facturadas, con factura pagada y no usadas
	 * previamente. Las averias quedan marcadas como usadas.
	 * 
	...
	public void testNoVoucherGeneratedWithOneNoSettled() throws BusinessException {
		...
		Averia a1 = registerNewInvoicedBreakdownFor(v);
		Averia a2 = registerNewInvoicedBreakdownFor(v);
		Averia a3 = registerNewBreakdownFor(v);
	 ...
	 */
	@Test
	public void testOneVoucherGeneratedWithFiveUsedThree() throws BusinessException {
	...
	/**
	 * Con tres clientes, se genera bono para dos. Cada cliente tienes tres averias,
	 * pero hay una sin pagar
	 */
	@Test
	public void testThreeClientsTwoVouchersGenerated() throws BusinessException {
		...
		List<Averia> avs3 = generateBreakdowns(2, 1);
	...
	private List<Averia> generateBreakdowns(int invoiced, int notInvoiced) throws BusinessException {
	...
	private List<Averia> generateInvoicedBreakdownsFor(Vehiculo v, int counter) throws BusinessException {
