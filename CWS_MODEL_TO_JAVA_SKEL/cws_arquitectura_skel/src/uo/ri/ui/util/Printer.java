...
public class Printer {
	...
	public static void printClient(ClientDto client) {
		...
		Console.printf("\t%d %-10.10s %-25.25s %-25.25s\n", client.id, client.dni, client.name, client.surname);
	}

	public static void printClientDetails(ClientDto client) {

		Console.printf("" + client.id + "\t" + client.dni + "\t" + client.name + "\t" + client.surname + "\t"
				+ client.addressStreet + "\t" + client.addressStreet + "\t" + client.addressZipcode + "\t"
